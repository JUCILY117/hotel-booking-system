        ...
        <div className="min-h-[calc(100vh-3.5rem)] grid lg:grid-cols-2 bg-gray-50 dark:bg-neutral-950 transition-colors">
            ...
            <div className="flex items-center justify-center p-6">
                <motion.form
                    ...
                    className="w-full max-w-md surface-elevated rounded-2xl border border-gray-200 dark:border-neutral-800 p-6 shadow-lg flex flex-col justify-center"
                    style={{ minHeight: "480px" }}
                >
                    <div className="flex-1 flex flex-col justify-center">
                        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 mb-1">Login</h1>
                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">Access your account</p>
        ...
        <div className="mb-3 relative">
            <div className="flex items-center gap-2 px-3 py-2.5 rounded-xl border border-gray-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 focus-within:ring-2 focus-within:ring-blue-500/40 transition">
                ...
                <button
                    ...
                    className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition focus:outline-none"
                >
